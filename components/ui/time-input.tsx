  ...
  ({ className, dateInputClassName, segmentClassName, disabled, "data-invalid": dataInvalid, ...props }, ref) => {
    ...
    return (
      ...
      >
        <DateInput
          className={cn(
            "peer inline-flex h-9 w-full items-center overflow-hidden whitespace-nowrap rounded-md px-3 py-2 text-sm shadow-black",
          ...
          {segment => (
            <DateSegment
              ...
              className={cn(
                ...
                notesTheme === "light" ? "" :"data-[focused]:text-gray-500",
