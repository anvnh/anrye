...
import FoldableHeading from '../../components/editor/features/FoldableHeading';
        ...
        components={{
          ...
          code: ({ children, className, ...props }) => {
            ...
            return (
              <div className="relative group/codeblock my-4 code-block-stable">
                {/* use createPortal to render alert outside the component tree */}
          ...
          img: ({ src, alt, ...props }) => {
            ...
            const OptimizedImage = React.useMemo(() => {
              return React.lazy(() => import('../../components/images/display/OptimizedImage').then(module => ({ default: module.default })));
            }, []);
            ...
            return (
              <div className="relative my-4 md-img-wrapper">
                ...
                {isEditorOpen && (
                  ...
                  React.createElement(require('../../components/images/editing/ImageEditor').default, {
                    ...
                    onSaved: async (newUrl: string) => {
                      ...
                      if (fileId) {
                        const { imageLoadingManager } = await import('../images/imageLoadingManager');
                ...
                {isLightboxOpen && (
                  // @ts-ignore dynamic import path
                  React.createElement(require('../../components/images/display/ImageLightbox').default, {
